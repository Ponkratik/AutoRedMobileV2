...
class CheckupDialogLessor(private val rideId: String) : DialogFragment() {
    private var _binding: FragmentDialogCheckupBinding? = null
    private val binding get() = requireNotNull(_binding)

    private val viewModel by viewModel<RideDetailsLessorViewModel>(owner = {requireParentFragment()})
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            buttonSign.setOnClickListener {
                ...
                viewModel.signActAfter(rideId, imagesListUri.map {
